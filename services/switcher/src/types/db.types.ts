...
export type CamerasResponse<
  ...
  Tinfo = unknown,
  Texpand = unknown
> = Required<CamerasRecord<Tautomation, Tconfiguration, Tinfo>> &
  BaseSystemFields<Texpand>;
export type ConfigurationsResponse<
  Tvalue = unknown,
  Texpand = unknown
> = Required<ConfigurationsRecord<Tvalue>> & BaseSystemFields<Texpand>;
export type LevelsResponse<Texpand = unknown> = Required<LevelsRecord> &
  BaseSystemFields<Texpand>;
...
export type RunResponse<Texpand = unknown> = Required<RunRecord> &
  BaseSystemFields<Texpand>;
